...
const ScrollToTop = () => {
  ...
  return (
    <div className={`progress-wrap ${progress > 5 ? 'active-progress' : ''}`} onClick={goToTop}>
      <div className="position-relative">
        ...
        <div className="position-absolute top-50 start-50 z-20" style={{ background: "transparent" }}>
